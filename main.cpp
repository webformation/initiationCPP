...
int main() {
    capteurTemperature<double> c1("essai",2);
    cout << c1.getNom() << endl;
    cout << boolalpha << c1.estValide() << endl;
    capteurTemperature<double> c2("essai",2);
    cout << "c2 : " <<  c2.getNom() << endl;
    cout << (c1==c2) << endl;
    cout << c2 << endl;
    float mn =20.f,mx =60.f;
    capteurTemperature<double> *pc1 = new capteurTemperature<double>("suite",3,mn,mx);
    cout << *pc1 << endl;
    cout << "Nombre de capteurs : " << pc1->getNb() << endl;
    capteurTemperature<double> c3(c2);
    cout << "Nombre de capteurs : " << capteurTemperature<double>::getNb() << endl;
    c3 = *pc1;
    cout << c3 << endl;
    capteur<double> *cap1 = &c3;
    //cout << *cap1 << endl;
